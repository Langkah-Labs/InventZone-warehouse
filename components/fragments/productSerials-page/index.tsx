...
import Table from "@/components/fragments/productSerials-page/Table";
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-4 body-base-regular text-gray-400">
            This feature aims to provide convenience in managing products that
            have serial numbers and make it easier for users to access
