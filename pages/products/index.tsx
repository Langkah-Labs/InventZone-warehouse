...
const Products: NextPageWithLayout<PageProps> = ({ products }) => {
  ...
  async function deleteProduct(id: string) {
    ...
    try {
      await graphqlRequest.request<any>(deleteProductByIdMutation, { id });
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-4 body-base-regular text-gray-400">
              This feature aims to provide easy and efficient access in managing
              products, including viewing, adding, changing, and deleting
              products.
            </p>
          </div>
