      ...
      {isLoading ? (
        ...
        <main className={`${raleway.className}`}>
          <div className="rounded-lg p-8 text-sky-600 underline underline-offset-4 shadow-md">
            <Link href="/hardware-connection" className="hover:text-sky-800">
              &#9664;&nbsp;Hardware Connection
            </Link>
          </div>
            ...
            <div className="sm:flex sm:items-center">
              <div className="sm:flex-auto">
                ...
                <p className="mt-4 body-base-regular text-gray-400">
                  This feature aims to be able to create or view the hardware
                  connection that is valid and can be used in the system
                </p>
              </div>
